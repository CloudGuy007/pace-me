(function() {
  ...
  function registerCtrl($scope, $state, AuthService, Upload, $timeout) {
    ...
    $scope.getUser = function() {
      if (!$scope.runner.photo) {
        if ($scope.runner.gender === 'male') {
          $scope.runner.photo = 'assets/images/male.png'
        } else {
          $scope.runner.photo = 'assets/images/female.png'
        }
      }
      console.log('runner', $scope.runner);
